  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="w-1/2 flex flex-col justify-center px-16 bg-white">
        ...
        <h2 className="text-5xl font-extrabold text-gray-800 text-center animate-fade-in">Join BorrowBox</h2>
        <p className="text-gray-500 text-center mb-6">Create an account and start renting instantly!</p>
      ...
      <div className="w-1/2 bg-gradient-to-r from-purple-500 to-indigo-600 flex items-center justify-center relative">
        <div className="text-center">
          ...
          />
          <h3 className="text-white text-3xl font-semibold mt-6 animate-fade-in">Start Your Renting Journey Now</h3>
        </div>
